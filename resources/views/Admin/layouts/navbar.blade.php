      ...
      <div class="sidebar">
          ...
          <div class="form-inline">
              <div class="input-group" data-widget="sidebar-search">
                  <input class="form-control form-control-sidebar" name="searchsidebar" type="search"
                      placeholder="Search" aria-label="Search">
                  <div class="input-group-append">
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          ...
                          <li class="nav-item">
                              <a href="" class="nav-link">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>Alt Kataqoriya Əlavə Et</p>
                              </a>
                          </li>
                          <li class="nav-item">
                            <a href="{{route('advert')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Yeni Reklam Əlavə Et</p>
                            </a>
                        </li>
                      </ul>
                  </li>
